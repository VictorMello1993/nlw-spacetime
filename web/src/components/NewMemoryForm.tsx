...
export function NewMemoryForm() {
  ...
  return (
    ...
    <button type="submit" className="inline-block rounded-full self-end bg-green-500 px-5 py-3 font-alt text-sm uppercase leading-none text-black hover:bg-green-600">Salvar</button>
  </form>
  );
}
